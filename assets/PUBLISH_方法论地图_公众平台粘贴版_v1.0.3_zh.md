> **2026-06-15** · 系列《AI 编程可闭环协作》· **方法论地图**（独立篇，无卷号）· release **v1.0.3**（v1.0.2 + §3 ICVO 脚注勘误）
...
> **阅读顺序**：**本篇（导读）** · [卷一](https://cloud.tencent.com/developer/article/2675471) · [卷二](https://cloud.tencent.com/developer/article/2676250) · [卷三](https://cloud.tencent.com/developer/article/2678669) · [卷四](https://cloud.tencent.com/developer/article/2680278) · [卷五](https://cloud.tencent.com/developer/article/2681115)
...
> **脚注 · v1.0.3 勘误（不改正文结构）**  
> 本文 **§3** 的 **ICV 三支柱** 归属 **SDD 方法论**，**不发明第四方法论支柱**——这一点 **不变**。  
> 开源产品 **cyning-harness** 在实现层将 [卷三](https://cloud.tencent.com/developer/article/2678669) 已写的 **帽链、Handoff、Epic 编排、invoke/review 落盘** 显式命名为产品支柱 **Orchestrate（编排）**，记作 **ICVO**（Inform · Constrain · Verify · **O**rchestrate）。  
> **Orchestrate 不是新方法论**：它是过程编排从「Harness 工具层」的 **产品化命名**，**不替代** Verify（CI/签收仍属第三支柱），**不推翻** 本文 SDD/ICV。只学公众方法论仍用 **ICV**；接入产品包时见产品文档 ICV↔ICVO 对照。
