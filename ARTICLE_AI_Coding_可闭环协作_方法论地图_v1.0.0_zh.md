...
可以把协作想成工地运输：**技术图谱** 是带方向的道路图，规定从哪扇门进、会连到哪些工区；Agent 默认只领 **一小张局部地图**（具体形式见连载 [卷二 §9](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol2_v1.0.0_zh.md)），而不是背下整座城市。**关卡** 对应 SDD 三支柱里的 **Verify**（及过程轨上的签收）：检查绿了没有、审查签了没有，过关才上主路。经验卡片或 Skill 是路口上的 **警示牌**——目的地仍在图上的 **入口节点**，不在牌子上。
...
> 「Harness」兼指业界 **Harness Engineering** 与连载 **任务单 + 阶段流 + 检查**（卷三）。**图谱轨** 服务 SDD 的 Inform / Constrain（读哪里、契约一致）。
...
**冷 / 温 / 热** 在连载里指 **协作记忆分层**（结构地图 / 协作轨迹 / 远期运行时记忆），**不是** 软件架构里的三层。**不是** 架构冷层、温层、热层——若团队内部另有同名术语，请在术语表写清映射，避免与系列混用（详见 [卷五 §23.1](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol5_v1.0.0_zh.md)；总论不展开）。
...
| 读者处境                     | 建议路径                                                                                                                                                                                                                  | 本篇已够可停                       |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| **Mentor / 评测 / 教模型写代码** | **本文全文** → [卷三 Harness](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol3_v1.4.0_zh.md)（Verify）→ [卷四 专题收尾与摘要](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol4_v1.1.0_zh.md) | 需要题集与轨迹细节时再下钻；本文 §4.1 可作出题模板 |
| **新项目 / 个人实验**           | 本文 → [卷一 §6 最小起步](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol1_v1.0.1_zh.md) → [卷二 图谱](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol2_v1.0.0_zh.md)                          | 只要原则时可停；动手优先卷一模板             |
| **存量 / 老项目**             | 本文 → [卷五 渐进路线](https://cloud.tencent.com/developer/article/2681115) · 卷三无 CI 降级                                                                                                        | 勿先卷二物化细节；先「验得动」再铺图           |
| **只要 Agent 读架构**         | 本文 §2～§3 → [卷二 技术图谱](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol2_v1.0.0_zh.md)                                                                                                                                   | 可跳过 Harness 细则；仍建议知 §4 验收概念  |
...
| 卷二  | [技术图谱](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol2_v1.0.0_zh.md) | 子图、读法对照、图谱 CI        |
...
若要动手：**新读者从 [卷一](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol1_v1.0.1_zh.md) 最小起步**；要地图读 **[卷二](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol2_v1.0.0_zh.md)**；要敢合并读 **卷三**；要合后沉淀读 **卷四**；老项目直接看 **卷五 阶段 0**，但仍建议 **浏览** 卷一～三要点。
