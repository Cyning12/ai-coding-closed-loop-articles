...
> **当前系列版本**：**`v1.2.0`** — 卷一～卷四均已 **release**（卷四 2026-06-01）。  
> **详规**：本文件；维护者私仓有同步副本。
...
| 层 | 示例 | 说明 |
| --- | --- | --- |
| **系列版** | **`v1.0.0`** | 里程碑；README / OUTLINE 表头；Git tag `series-v1.0.0` |
| **卷内版** | 卷一 `v0.1.11` · 卷二 `v0.8.2` | 单篇文件修订；**不改** 系列版 patch 除非勘误已 release 卷 |
...
| 卷 | 文件 | 卷内版 |
| --- | --- | --- |
| 卷一 | [`ARTICLE_*_v0.1_zh.md`](./ARTICLE_AI_Coding_可闭环协作_公众稿_v0.1_zh.md) | v0.1.11 |
...
| 卷四 | [`ARTICLE_*_vol4_v1.0.0_zh.md`](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol4_v1.0.0_zh.md) | v1.0.0 |
...
```bash
git tag -a series-v1.0.0 -m "Series v1.0.0: 卷一+卷二 release"
git push origin series-v1.0.0
```
