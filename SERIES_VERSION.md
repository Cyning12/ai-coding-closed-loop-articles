...
> **当前系列版本**：**`v1.4.0`** — 卷一～卷五 **GitHub release**（卷一～四腾讯云已发；卷五 **v1.0.0** · 2026-06-02 · 腾讯云待发）。  
> **详规**：本文件；维护者私仓有同步副本。
...
| 卷 | 文件 | 卷内版 |
| --- | --- | --- |
| 卷一 | [`ARTICLE_*_v0.1_zh.md`](./ARTICLE_AI_Coding_可闭环协作_公众稿_v0.1_zh.md) | **v1.0.1** |
...
| 卷四 | [`ARTICLE_*_vol4_v1.0.0_zh.md`](./ARTICLE_AI_Coding_可闭环协作_公众稿_vol4_v1.0.0_zh.md) | **v1.1.0** |
...
| 2026-06-02 | 卷五 GitHub release **v1.0.0**（源自私仓 draft v0.7.5）→ 系列 **v1.4.0** |
